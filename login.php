...
<head>
    ...
    <title>Iniciar sesion - VxT</title>
        ...
        <div class="row justify-content-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="login_back.php" method="POST">
            ...
            if (input.type === "password") {
                ...
                toggle.className = "fas fa-eye-slash";
                                        ...
                                        <div class="form-group">
                                        <input type="password" id="pass" name="pass" class="form-control form-control-user" placeholder="Clave" required>
                                    ...
                                    <hr>
                                   <a href="registrarusuarioasm.php">Registrar usuario ASM</a><br>
                                   <a href="registrarusuariovxt.php">Registrar usuario VXT</a>
