...
$CambioVendedor = "";
$CambioVendedor = filter_var($_POST['cambiovendedor'], FILTER_SANITIZE_SPECIAL_CHARS);
...
if (mysqli_num_rows($searchResult) > 0) {
   ...
   echo $updateQuery = "UPDATE `ventas` SET " . implode(', ', $setFields) . " WHERE id = $venta_id";
