...
<label for="tarjetadecredito_fibra">Tarjeta de crédito:</label>
    ...
    <div id="archivos-container">
        <input type="file" class="form-control-file" id="archivos_fibra" name="archivos[]" multiple><br>
    </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#archivos_fibra').change(previsualizarArchivos);
