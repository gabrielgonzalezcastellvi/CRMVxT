...
$queryPostVenta = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'POST VENTA' AND vendedor = '$vendedor'";
$resultPostVenta = mysqli_query($conexion, $queryPostVenta);
$totalIngresoPostVenta = mysqli_fetch_assoc($resultPostVenta)['total'];

// Obtener el total de ventas cargadas
$queryRechazoABD = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'RECHAZO ABD' AND vendedor = '$vendedor'";
$resultRechazoABD = mysqli_query($conexion, $queryRechazoABD);
$totalRechazoABD = mysqli_fetch_assoc($resultRechazoABD)['total'];

// Obtener el total de ventas cargadas
$queryCancelada = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%CANCELADA%' AND vendedor = '$vendedor'";
$resultCancelada = mysqli_query($conexion, $queryCancelada);
$totalSolicitudesCanceladas = mysqli_fetch_assoc($resultCancelada)['total'];

// Obtener el total de ventas cargadas
$queryDevuelta = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DEVUELTA' AND vendedor = '$vendedor'";
$resultDevuelta = mysqli_query($conexion, $queryDevuelta);
$totalDevuelta = mysqli_fetch_assoc($resultDevuelta)['total'];

// Obtener el total de ventas cargadas
$queryPendienteDeVerificacion = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%PENDIENTE DE VERIFICACION%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryPendienteAuditoria = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%PENDIENTE AUDITORIA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryInformadaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%INFORMADA TASA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryPendienteCargaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%PENDIENTE CARGA TASA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryIngresadaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%INGRESADA TASA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryEnTransito = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%EN TRANSITO%' AND vendedor = '$vendedor'";
$resultEnTransito = mysqli_query($conexion, $queryEnTransito);
$totalEnTransito = mysqli_fetch_assoc($resultEnTransito)['total'];

// Obtener el total de ventas cargadas
$queryEnProcesoDigipTn = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%EN PROCESO DIGIP-TN%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDiferisaCargaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%DIFERIDA CARGA TASA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaXVerificacion = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%DEVUELTA X VERIFICACION%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaXAuditoria = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%DEVUELTA X AUDITORIA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaCargaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%DEVUELTA CARGA TASA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDiferidaAuditoria = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DIFERIDA AUDITORIA' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$querySolicitudCumplida= "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%CUMPLIDA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaPorVendedor = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%DEVUELTA X VENDEDOR%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%DEVUELTA TASA%' AND vendedor = '$vendedor'";
$resultDevueltaTasa = mysqli_query($conexion, $queryDevueltaTasa);
$totalDevueltaTasa = mysqli_fetch_assoc($resultDevueltaTasa)['total'];

// Obtener el total de ventas cargadas
$querySolicitudCancelada = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%CANCELADA%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryPendienteCargaMovistar = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%PENDIENTE CARGA MOVISTAR%' AND vendedor = '$vendedor'";
...
$queryDiferidaCargaMovistar = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%DIFERIDA CARGA MOVISTAR%' AND vendedor = '$vendedor'";
...
$queryPendienteCargaIris = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%PENDIENTE CARGA IRIS%' AND vendedor = '$vendedor'";
...
$queryDevueltaCargaMovistar = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%DEVUELTA CARGA MOVISTAR%' AND vendedor = '$vendedor'";
...
$queryIngresadaMovistar = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%INGRESADA MOVISTAR%' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryPostVenta2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'POST VENTA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
$resultPostVenta2 = mysqli_query($conexion, $queryPostVenta2);
$totalIngresoPostVenta2 = mysqli_fetch_assoc($resultPostVenta2)['total'];

// Obtener el total de ventas cargadas
$queryRechazoABD2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'RECHAZO ABD' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
$resultRechazoABD2 = mysqli_query($conexion, $queryRechazoABD2);
$totalRechazoABD2 = mysqli_fetch_assoc($resultRechazoABD2)['total'];

// Obtener el total de ventas cargadas
$queryCancelada2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%CANCELADA%' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevuelta2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DEVUELTA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
$resultDevuelta2 = mysqli_query($conexion, $queryDevuelta2);
$totalDevuelta2 = mysqli_fetch_assoc($resultDevuelta2)['total'];

// Obtener el total de ventas cargadas
$queryPendienteDeVerificacion2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'PENDIENTE DE VERIFICACION' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryPendienteAuditoria2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'PENDIENTE AUDITORIA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryInformadaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'INFORMADA TASA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryPendienteCargaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'PENDIENTE CARGA TASA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryIngresadaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'INGRESADA TASA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryEnTransito2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'EN TRANSITO' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
$resultEnTransito2 = mysqli_query($conexion, $queryEnTransito2);
$totalEnTransito2 = mysqli_fetch_assoc($resultEnTransito2)['total'];

// Obtener el total de ventas cargadas
$queryEnProcesoDigipTn2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'EN PROCESO DIGIP-TN' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDiferidaCargaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DIFERIDA CARGA TASA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaXVerificacion2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DEVUELTA X VERIFICACION' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaXAuditoria2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DEVUELTA X AUDITORIA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaCargaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DEVUELTA CARGA TASA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDiferidaAuditoria2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DIFERIDA AUDITORIA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$querySolicitudCumplida2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%CUMPLIDA%' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaPorVendedor2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DEVUELTA POR VENDEDOR' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryDevueltaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DEVUELTA TASA' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$querySolicitudCancelada2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa LIKE '%CANCELADA%' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
// Obtener el total de ventas cargadas
$queryPendienteCargaMovistar2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'PENDIENTE CARGA MOVISTAR' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
$queryDiferidaCargaMovistar2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DIFERIDA CARGA MOVISTAR' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
$queryPendienteCargaIris2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'PENDIENTE CARGA IRIS' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
$queryDevueltaCargaMovistar2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'DEVUELTA CARGA MOVISTAR' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
$queryIngresadaMovistar2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND estadoventa = 'INGRESADA MOVISTAR' AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
$queryTotalMes = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND vendedor = '$vendedor'";
$resultTotalMes = mysqli_query($conexion, $queryTotalMes);
$TotalMes = mysqli_fetch_assoc($resultTotalMes)['total'];


$queryTotalDia = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE DATE_FORMAT(fechacarga, '%Y-%m') = DATE_FORMAT(CURDATE(), '%Y-%m') AND fechacarga = '$Date' AND vendedor = '$vendedor'";
...
<?php if($TotalMes > 0){ ?>
        ...
        <div class="card-body">
               ...
               <canvas id="PieChart<?php echo $vendedor;?>" width="400" height="400"></canvas>
...
<div class="card shadow mb-4">
        ...
        <div class="card-body">
               ...
               <canvas id="PieChart2<?php echo $vendedor;?>" width="400" height="400"></canvas>
