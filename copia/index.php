                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas";
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%POST VENTA%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%Pendiente%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
...
$queryCargadas = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas";
...
$queryPendientes = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%Pendiente%'";
...
$queryAprobadas = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%'";
...
$queryCancelada = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%CANCELADA%'";
$resultCancelada = mysqli_query($conexion, $queryCancelada);
$totalCanceladas = mysqli_fetch_assoc($resultCancelada)['total'];

$queryIngresadaTASA = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%INGRESADA TASA%'";
...
$queryIngresaAuditoria = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%AUDITORIA%'";
...
$queryIngresaRechazo = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%RECHAZO%'";
...
$queryIngresoPostVenta = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%POST VENTA%'";
...
$Date = date('Y-m-d');
// Obtener el total de ventas cargadas
$queryCargadas2 = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE fechacarga LIKE '%$Date%'";  
$resultCargadas2 = mysqli_query($conexion, $queryCargadas2);
$totalCargadas2 = mysqli_fetch_assoc($resultCargadas2)['total'];

// Obtener el total de ventas pendientes
$queryPendientes2 = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%Pendiente%' AND fechacarga LIKE '%$Date%'";
$resultPendientes2 = mysqli_query($conexion, $queryPendientes2);
$totalPendientes2 = mysqli_fetch_assoc($resultPendientes2)['total'];

// Obtener el total de ventas aprobadas
$queryAprobadas2 = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%' AND fechacarga LIKE '%$Date%'";
$resultAprobadas2 = mysqli_query($conexion, $queryAprobadas2);
$totalAprobadas2 = mysqli_fetch_assoc($resultAprobadas2)['total'];


// Obtener el total de ventas canceladas
$queryCancelada2 = "SELECT COUNT(DISTINCT documentocliente,linea) as total FROM ventas WHERE estadoventa LIKE '%CANCELADA%' AND fechacarga LIKE '%$Date%'";
$resultCancelada2 = mysqli_query($conexion, $queryCancelada2);
$totalCanceladas2 = mysqli_fetch_assoc($resultCancelada2)['total'];

$queryIngresadaTASA2 = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%INGRESADA TASA%' AND fechacarga LIKE '%$Date%'";
...
$queryIngresaAuditoria2 = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%AUDITORIA%' AND fechacarga LIKE '%$Date%'";
...
$queryIngresaRechazo2 = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%RECHAZO%' AND fechacarga LIKE '%$Date%'";
...
$queryIngresoPostVenta2 = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%POST VENTA%' AND fechacarga LIKE '%$Date%'";
...
#$totalVentas = $totalCargadas + $totalPendientes + $totalAprobadas + $totalVerificar + $totalCanceladas + $totalIngresadaTASA + $totalIngresadaAuditoria;
