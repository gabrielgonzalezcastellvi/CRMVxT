...
<body id="page-top">
 ...
 -->
    ...
    <input type="text" class="form-control" id="linea_fibra" name="lineas" required><br><br>
    ...
    <input type="text" class="form-control" id="cuitcliente_fibra" name="cuitcliente" required><br><br>
    ...
    <input type="email" class="form-control" id="email_fibra" name="email" required><br><br>
    ...
    <input type="text" class="form-control" id="provincia_fibra" name="provincia" required><br><br>
    ...
    <input type="text" class="form-control" id="coordenadas_fibra" name="coordenadas" required><br><br>
    <label for="linkmaps">Link Google Maps:</label>
    <input type="text" class="form-control" id="maps_fibra" name="maps" required><br><br>
    ...
    <input type="file" class="form-control-file" id="archivos_fibra" name="archivos[]" multiple><br><br>
    </div>
</div>
...
$(document).ready(function(){
    ...
    $('#archivos_fibra').change(function(){
        $('#preview').empty();
    ...
    $('#formulario_venta-fibra').submit(function(e){
        e.preventDefault();
