    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index2.php">
                ...
                <div class="sidebar-brand-text mx-3"><?php session_start(); echo '<h4>Bienvenido '.$_SESSION['Nombre'].'</h4>';?></div>
            </a>
           ...
           <li class="nav-item active">
                <a class="nav-link" href="cargaporta2.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Cargar porta</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="cargafibra2.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Cargar fibra</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="solicitudes2.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Solicitudes de venta</span></a>
            </li>
...
$Query = "SELECT * FROM historialingresos  WHERE cliente = '$Cliente' LIMIT $registros_por_pagina OFFSET $offset";
...
<div class="pagination">
    <ul class="pagination">
        ...
        $total_query = "SELECT COUNT(*) AS total FROM registroingresos";
