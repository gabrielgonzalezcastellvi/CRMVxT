...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="cargaporta.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Cargar porta</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="cargafibra.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
...
$Query = "SELECT * FROM historialingresos ORDER BY id DESC LIMIT $registros_por_pagina OFFSET $offset";
