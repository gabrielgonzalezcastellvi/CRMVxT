...
<form action="procesar_usuarios.php" method="post" id="formulario_venta-porta" enctype="multipart/form-data">
    <?php
    require 'conexion.php';
...
function buscarLinea() {
   ...
   <label for="contrasena">Contraseña:</label>
    <input type="text" class="form-control" id="contrasena" name="contrasena" value="VxT2024" disabled><br><br>
</div>
