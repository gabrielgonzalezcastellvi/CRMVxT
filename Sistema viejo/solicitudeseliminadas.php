...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $Query5 = "SELECT COUNT(DISTINCT linea, documentocliente) as TotalBusqueda FROM ventaseliminadas";
    ...
    $Query = "SELECT * FROM ventaseliminadas GROUP BY documentocliente, linea ORDER BY id DESC LIMIT $registros_por_pagina OFFSET $offset";
...
$Query3 = "SELECT COUNT(DISTINCT linea,documentocliente) as total FROM ventaseliminadas";
$Result = mysqli_query($conexion, $Query);
...
$date = '';
$date = date('Y-m-d'); 
$Query4 = "SELECT COUNT(DISTINCT linea,documentocliente) as totalcarga FROM ventaseliminadas WHERE fechacarga = '$date'";
...
?>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h2 class="h3 mb-0 text-gray-800">Solicitudes del día eliminadas:  <b><?php echo $Date; ?></b></h2>
...
<textarea name="comments" class="form-control" id="" cols="90" rows="5"><?php echo $row['comentarios']?></textarea>
          ...
          <?php
  $query_documentos = "SELECT DISTINCT(archivo) FROM ventaseliminadas WHERE documentocliente = '" . $row['documentocliente'] . "'";
