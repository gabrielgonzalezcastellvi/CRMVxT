...
<form action="procesar_usuarios.php" method="post" id="formulario_venta-porta" enctype="multipart/form-data">
    ...
    <input type="email" class="form-control" id="nivel" name="correo" required><br><br>
   ...
   <label for="contrasena">Contraseña:</label>
    <input type="text" class="form-control" id="contrasena" name="contrasena" required><br><br>
</div>
