...
<form action="procesar_perfil2.php" method="post" id="formulario_perfil" enctype="multipart/form-data">
    <?php
    require 'conexion.php';
    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <form action="procesar_perfil.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="clave" class="form-control" value="<?php echo $row['contrasena'];?>" id="">
                <br>
