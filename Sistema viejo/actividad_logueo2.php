                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <div class="sidebar-brand-text mx-3"><?php echo '<h4>Bienvenido '.$_SESSION['Nombre'].'</h4>';?></div>
                                <?php 
                                ...
                                if(!empty($Foto)){
                                  ...
                                  src="./perfiles/'echo $Foto;'>';
                                }else{
                                  echo '<img class="img-profile rounded-circle"
                                  src="./perfiles/Captura de pantalla 2024-05-22 213747.png">';
                                } 
