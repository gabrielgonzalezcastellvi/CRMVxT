    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="mr-2 d-none d-lg-inline text-black-600 small"><?php session_start(); echo 'Bienvenid@ '.$_SESSION['Nombre'];?></div>
            </a>
...
?>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Lista usuarios</h2>
                        <?php
            ...
            success: function(response){
                ...
                $('#resultado').html(response);
                       ...
                       <!--  <form method="post" action="pdf.php">
                        ...
                        <input type="hidden" name="consulta" value="<?php echo base64_encode($Query2); ?>">
                        <input type="submit" value="Generar CSV de usuarios" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                </form> -->
                    </div>
    <?php 
    require 'conexion.php';
