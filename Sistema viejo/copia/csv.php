...
$sql = "SELECT vendedor,estadoventa,fechaportacion,producto,linea,nombrecliente,documentocliente,numeroalternativo,planes,score,fechacarga,fechanacimientocliente,calle,numero,entrecalles,provincia,localidad,codigopostal " . $sql_despues_from;
...
if ($result->num_rows > 0) {
    ...
    $header = array("Vendedor", "Estado venta", "Fecha de portacion", "Producto", "Linea","Nombre cliente","Documento cliente","Numero alternativo","Plan","Score","Fecha carga","Fecha nacimiento cliente","Calle","Altura","Entre calles","Provincia","Localidad","Codigo postal"); // Cambia los nombres por las adecuadas
    fputcsv($fp, $header);
