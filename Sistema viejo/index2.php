                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE vendedor = '$Vendedor'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%POST VENTA%' AND vendedor = '$Vendedor'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Vendedor = $_SESSION['Nombre'];
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%' AND vendedor = '$Vendedor'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
...
$queryCargadas = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE vendedor = '$Vendedor'";
...
$queryPendientes = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%Pendiente%' AND vendedor = '$Vendedor'";
...
$queryAprobadas = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%' AND vendedor = '$Vendedor'";
...
$queryIngresaRechazo = "SELECT COUNT(DISTINCT documentocliente, linea,producto) as total FROM ventas WHERE estadoventa LIKE '%RECHAZO%' AND vendedor = '$Vendedor'";
...
$queryIngresoPostVenta = "SELECT COUNT(DISTINCT documentocliente, linea,producto) as total FROM ventas WHERE estadoventa LIKE '%POST VENTA%' AND vendedor = '$Vendedor'";
...
$Date = date('Y-m-d');
// Obtener el total de ventas cargadas
$queryCargadas2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE fechacarga LIKE '%$Date%' AND vendedor = '$Vendedor'";  
$resultCargadas2 = mysqli_query($conexion, $queryCargadas2);
$totalCargadas2 = mysqli_fetch_assoc($resultCargadas2)['total'];

// Obtener el total de ventas pendientes
$queryPendientes2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%Pendiente%' AND fechacarga LIKE '%$Date%' AND vendedor = '$Vendedor'";
$resultPendientes2 = mysqli_query($conexion, $queryPendientes2);
$totalPendientes2 = mysqli_fetch_assoc($resultPendientes2)['total'];

// Obtener el total de ventas aprobadas
$queryAprobadas2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%' AND fechacarga LIKE '%$Date%' AND vendedor = '$Vendedor'";
...
// Obtener el total de ventas canceladas
$queryCancelada2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CANCELADA%' AND fechacarga LIKE '%$Date%' AND vendedor = '$Vendedor'";
$resultCancelada2 = mysqli_query($conexion, $queryCancelada2);
$totalCanceladas2 = mysqli_fetch_assoc($resultCancelada2)['total'];

$queryIngresadaTASA2 = "SELECT COUNT(DISTINCT documentocliente, linea,producto) as total FROM ventas WHERE estadoventa LIKE '%INGRESADA TASA%' AND fechacarga LIKE '%$Date%' AND vendedor = '$Vendedor'";
...
$queryIngresaAuditoria2 = "SELECT COUNT(DISTINCT documentocliente, linea,producto) as total FROM ventas WHERE estadoventa LIKE '%AUDITORIA%' AND fechacarga LIKE '%$Date%' AND vendedor = '$Vendedor'";
...
$queryIngresaRechazo2 = "SELECT COUNT(DISTINCT documentocliente, linea,producto) as total FROM ventas WHERE estadoventa LIKE '%RECHAZO%' AND fechacarga LIKE '%$Date%' AND vendedor = '$Vendedor'";
...
$queryIngresoPostVenta2 = "SELECT COUNT(DISTINCT documentocliente, linea,producto) as total FROM ventas WHERE estadoventa LIKE '%POST VENTA%' AND fechacarga LIKE '%$Date%' AND vendedor = '$Vendedor'";
