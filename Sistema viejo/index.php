                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                        ...
                                        <div class="col-auto">
                                        <a href="solicitudes.php"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%POST VENTA%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                        ...
                                        <div class="col-auto">
                                        <a href="solicitudes.php?estado=post"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                        ...
                                        <div class="col-auto">
                                        <a href="solicitudes.php?estado=cumplida"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%Pendiente%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                        ...
                                        <div class="col-auto">
                                        <a href="solicitudes.php?estado=pendiente"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%cancelada%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                        ...
                                        <div class="col-auto">
                                        <a href="solicitudes.php?estado=cancelada"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-purple shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%INGRESADA TASA%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                            ...
                                            <div class="text-xs font-weight-bold text-purple text-uppercase mb-1">
                                                Ventas ingresadas a tasa  <?php echo $Total; ?></div>
                                           <!--  <div class="h5 mb-0 font-weight-bold text-gray-800">18</div> -->
                                        </div>
                                        <div class="col-auto">
                                        <a href="solicitudes.php?estado=INGRESADA+TASA"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-purple shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%AUDITORIA%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                            ?>
                                            <div class="text-xs font-weight-bold text-purple text-uppercase mb-1">
                                                Ventas para auditoria  <?php echo $Total; ?></div>
                                           <!--  <div class="h5 mb-0 font-weight-bold text-gray-800">18</div> -->
                                        </div>
                                        <div class="col-auto">
                                        <a href="solicitudes.php?estado=auditoria"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-grey shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%RECHAZO%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                        ...
                                        <div class="col-auto">
                                        <a href="solicitudes.php?estado=RECHAZO+ABD"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-grey shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <?php 
                                            require 'conexion.php';
                                            $Query = "SELECT COUNT(DISTINCT documentocliente, linea) as total FROM ventas WHERE estadoventa LIKE '%DEVUELTA%'";
                                            $Result = mysqli_query($conexion,$Query);
                                            while($row = $Result -> fetch_assoc()){
                                                $Total = $row['total'];
                                            }
                                            ?>
                                            <div class="text-xs font-weight-bold text-gray text-uppercase mb-1">
                                                Ventas devueltas  <?php echo $Total; ?></div>
                                           <!--  <div class="h5 mb-0 font-weight-bold text-gray-800">18</div> -->
                                        </div>
                                        <div class="col-auto">
                                        <a href="solicitudes.php?estado=devuelta"><i class="fas fa-clipboard-list fa-2x text-gray-250"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$queryPostVenta = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'POST VENTA'";
$resultPostVenta = mysqli_query($conexion, $queryPostVenta);
$totalIngresoPostVenta = mysqli_fetch_assoc($resultPostVenta)['total'];

// Obtener el total de ventas cargadas
$queryRechazoABD = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'RECHAZO ABD'";
$resultRechazoABD = mysqli_query($conexion, $queryRechazoABD);
$totalRechazoABD = mysqli_fetch_assoc($resultRechazoABD)['total'];

// Obtener el total de ventas cargadas
$queryCancelada = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CANCELADA%'";
$resultCancelada = mysqli_query($conexion, $queryCancelada);
$totalSolicitudesCanceladas = mysqli_fetch_assoc($resultCancelada)['total'];

// Obtener el total de ventas cargadas
$queryDevuelta = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA'";
$resultDevuelta = mysqli_query($conexion, $queryDevuelta);
$totalDevuelta = mysqli_fetch_assoc($resultDevuelta)['total'];

// Obtener el total de ventas cargadas
$queryPendienteDeVerificacion = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE DE VERIFICACION'";
...
// Obtener el total de ventas cargadas
$queryPendienteAuditoria = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE AUDTORIA'";
...
// Obtener el total de ventas cargadas
$queryInformadaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'INFORMADA TASA'";
...
// Obtener el total de ventas cargadas
$queryPendienteCargaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE CARGA TASA'";
...
// Obtener el total de ventas cargadas
$queryIngresadaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'INGRESADA TASA'";
...
// Obtener el total de ventas cargadas
$queryEnTransito = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'EN TRANSITO'";
$resultEnTransito = mysqli_query($conexion, $queryEnTransito);
$totalEnTransito = mysqli_fetch_assoc($resultEnTransito)['total'];

// Obtener el total de ventas cargadas
$queryEnProcesoDigipTn = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'EN PROCESO DIGIP-TN'";
...
// Obtener el total de ventas cargadas
$queryDiferisaCargaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DIFERIDA CARGA TASA'";
...
// Obtener el total de ventas cargadas
$queryDevueltaXVerificacion = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA X VERIFICACION'";
...
// Obtener el total de ventas cargadas
$queryDevueltaXAuditoria = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA X AUDITORIA'";
...
// Obtener el total de ventas cargadas
$queryDevueltaCargaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA CARGA TASA'";
...
// Obtener el total de ventas cargadas
$queryDiferidaAuditoria = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DIFERIDA AUDITORIA'";
...
// Obtener el total de ventas cargadas
$querySolicitudCumplida= "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%'";
...
// Obtener el total de ventas cargadas
$queryDevueltaPorVendedor = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA POR VENDEDOR'";
...
// Obtener el total de ventas cargadas
$queryDevueltaTasa = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA TASA'";
$resultDevueltaTasa = mysqli_query($conexion, $queryDevueltaTasa);
$totalDevueltaTasa = mysqli_fetch_assoc($resultDevueltaTasa)['total'];

// Obtener el total de ventas cargadas
$querySolicitudCancelada = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CANCELADA%'";
...
// Obtener el total de ventas cargadas
$queryPendienteCargaMovistar = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE CARGA MOVISTAR'";
...
$queryDiferidaCargaMovistar = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DIFERIDA CARGA MOVISTAR'";
...
$queryPendienteCargaIris = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE CARGA IRIS'";
...
$queryDevueltaCargaMovistar = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA CARGA MOVISTAR'";
...
$queryIngresadaMovistar = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'INGRESADA MOVISTAR'";
...
// Obtener el total de ventas cargadas
$queryPostVenta2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'POST VENTA' AND fechacarga = '$Date'";
$resultPostVenta2 = mysqli_query($conexion, $queryPostVenta2);
$totalIngresoPostVenta2 = mysqli_fetch_assoc($resultPostVenta2)['total'];

// Obtener el total de ventas cargadas
$queryRechazoABD2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'RECHAZO ABD' AND fechacarga = '$Date'";
$resultRechazoABD2 = mysqli_query($conexion, $queryRechazoABD2);
$totalRechazoABD2 = mysqli_fetch_assoc($resultRechazoABD2)['total'];

// Obtener el total de ventas cargadas
$queryCancelada2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CANCELADA%' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryDevuelta2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA' AND fechacarga = '$Date'";
$resultDevuelta2 = mysqli_query($conexion, $queryDevuelta2);
$totalDevuelta2 = mysqli_fetch_assoc($resultDevuelta2)['total'];

// Obtener el total de ventas cargadas
$queryPendienteDeVerificacion2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE DE VERIFICACION' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryPendienteAuditoria2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE AUDTORIA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryInformadaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'INFORMADA TASA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryPendienteCargaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE CARGA TASA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryIngresadaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'INGRESADA TASA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryEnTransito2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'EN TRANSITO' AND fechacarga = '$Date'";
$resultEnTransito2 = mysqli_query($conexion, $queryEnTransito2);
$totalEnTransito2 = mysqli_fetch_assoc($resultEnTransito2)['total'];

// Obtener el total de ventas cargadas
$queryEnProcesoDigipTn2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'EN PROCESO DIGIP-TN' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryDiferidaCargaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DIFERIDA CARGA TASA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryDevueltaXVerificacion2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA X VERIFICACION' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryDevueltaXAuditoria2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA X AUDITORIA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryDevueltaCargaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA CARGA TASA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryDiferidaAuditoria2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DIFERIDA AUDITORIA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$querySolicitudCumplida2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CUMPLIDA%' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryDevueltaPorVendedor2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA POR VENDEDOR' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryDevueltaTasa2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA TASA' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$querySolicitudCancelada2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa LIKE '%CANCELADA%' AND fechacarga = '$Date'";
...
// Obtener el total de ventas cargadas
$queryPendienteCargaMovistar2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE CARGA MOVISTAR' AND fechacarga = '$Date'";
...
$queryDiferidaCargaMovistar2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DIFERIDA CARGA MOVISTAR' AND fechacarga = '$Date'";
...
$queryPendienteCargaIris2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'PENDIENTE CARGA IRIS' AND fechacarga = '$Date'";
...
$queryDevueltaCargaMovistar2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'DEVUELTA CARGA MOVISTAR' AND fechacarga = '$Date'";
...
$queryIngresadaMovistar2 = "SELECT COUNT(DISTINCT documentocliente,linea,producto) as total FROM ventas WHERE estadoventa = 'INGRESADA MOVISTAR' AND fechacarga = '$Date'";
