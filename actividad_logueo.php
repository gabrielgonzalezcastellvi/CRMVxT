...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
            ...
            <div class="mr-2 d-none d-lg-inline text-black-600 small"><?php echo '<h4>Bienvenido ' . $_SESSION['Nombre'] . '</h4>'; ?></div>
        </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                $QueryClientes = "SELECT DISTINCT(cliente) AS clientes FROM historialingresos WHERE cliente <> '' AND fecha <> ''";
                $ResultClientes = mysqli_query($conexion, $QueryClientes);

                // Array para almacenar los resultados de la consulta SQL
                $clientesConFechaMinima = array();

                // Iterar sobre los clientes
                while ($rowCliente = $ResultClientes->fetch_assoc()) {
                    $Cliente = $rowCliente['clientes'];

                    // Consulta SQL para obtener la fecha mínima de ingreso del día actual para este cliente
                    echo $QueryFechaMinima = "SELECT cliente, MIN(fecha) AS primera_fecha_ingreso FROM historialingresos WHERE cliente = '$Cliente' AND DATE(fecha) = CURDATE() AND fecha <> '' AND cliente <> ''";
                    $ResultFechaMinima = mysqli_query($conexion, $QueryFechaMinima);

                    // Almacenar los resultados en el array
                    $rowFechaMinima = $ResultFechaMinima->fetch_assoc();
                    $clientesConFechaMinima[] = $rowFechaMinima;
                }

                // Mostrar los resultados en una tabla HTML
                ?>
                <h2>Actividad de logueo</h2>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                        <?php foreach ($clientesConFechaMinima as $row) { ?>
                            <tr>
                                <td><?php echo $row['cliente']; ?></td>
                                <td><?php echo $row['primera_fecha_ingreso']; ?></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
                ...
                <div class="pagination">
                    <ul class="pagination">
                        ...
                        $total_query = "SELECT COUNT(*) AS total FROM historialingresos";
