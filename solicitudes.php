...
?>   
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <?php 
if ($Date > 0) {
    echo '<h2 class="h3 mb-0 text-gray-800">Solicitudes del día: <b><a href="solicitudesRODRIGO?ventasdia=' . $date . '">' . $Date . '</a></b></h2>';
} else {
...
<?php  
if ($Devueltas > 0) {
    echo '<h2 class="h3 mb-0 text-gray-800">Solicitudes devueltas: <b><a href="solicitudesRODRIGO?estado%5B%5D=DEVUELTA">'.$Devueltas.'</a></b></h2>';
}
?>         
